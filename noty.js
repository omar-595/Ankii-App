...
add.addEventListener("click", () => {
  ...
  titlePopup.innerText = "Add New Noty";
  textarea.value = "";
  input.value = "";
});
// handle close popup
  ...
  notes.forEach((note, idx) => {
    let card = `
        ...
        <div class="menu-app">
            ...
            <ul class="menu">
              <li onclick="editNote(${idx}, '${note.title}', '${note.description}')"><i class="fa fa-edit"></i> Edet</li>
              <li onclick="removeNote(${idx})"><i class="fa fa-trash-alt"></i> Deleat</li>
            </ul>
          </div>
        </div>
      </div>
...
function editNote(idNote, title, description) {
  ...
  idEdit = idNote;
  add.click();
  titlePopup.innerText = "Update Noty";
